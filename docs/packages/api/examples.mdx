...
[View in API reference](/packages/./api/functions#scanrepoforversions)
...
[View in API reference](/packages/./api/functions#generatedependabotconfig)
...
[View in API reference](/packages/./api/functions#writedependabotconfig)
...
[View in API reference](/packages/./api/functions#dependabotconfigexists)
...
[View in API reference](/packages/./api/functions#checkpublishstatus)
...
[View in API reference](/packages/./api/functions#readpackagename)
