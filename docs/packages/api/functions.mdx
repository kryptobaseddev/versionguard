...
## generateDependabotConfig(manifests)
...
| Name        | Type                   | Description                                      |
| ----------- | ---------------------- | ------------------------------------------------ |
| `manifests` | `ManifestSourceType[]` | Detected manifest source types from the project. |
...
## writeDependabotConfig(cwd, content)
...
## checkPublishStatus(manifestSource, packageName, version, config)
...
| Name             | Type                 | Description                                                   |
| ---------------- | -------------------- | ------------------------------------------------------------- |
| `manifestSource` | `ManifestSourceType` | The detected manifest source type.                            |
| `packageName`    | `string`             | Package name as read from the manifest.                       |
| `version`        | `string`             | Version string to check.                                      |
| `config`         | `PublishConfig`      | Publish configuration with timeout and optional registry URL. |
...
## readPackageName(manifestSource, cwd)
...
| Name             | Type                 | Description             |
| ---------------- | -------------------- | ----------------------- |
| `manifestSource` | `ManifestSourceType` | Detected manifest type. |
| `cwd`            | `string`             | Project directory.      |
...
| `cwd`    | `: string`           | Project directory to inspect.                       |
| `mode`   | `: ValidateMode`     | Validation mode: 'full' (default) or 'lightweight'. |
